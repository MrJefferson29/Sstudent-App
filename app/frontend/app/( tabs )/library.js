...
return ( <View style={styles.container} showsHorizontalScrollIndicator='false'>
{/* Header */} <Text style={styles.header}>Library</Text>
...
container: { flex: 1, backgroundColor: "#f7f9fc", paddingHorizontal: 15 },
